...
class OrthographicOverride : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        Internal = typeof(UnityEngine.Experimental.Rendering.Universal.PixelPerfectCamera).GetField("m_Internal", BindingFlags.NonPublic | BindingFlags.Instance).GetValue(GetComponent<PixelPerfectCamera>());
